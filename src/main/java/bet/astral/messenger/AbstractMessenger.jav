...
import bet.astral.messenger.message.ComponentType;
import bet.astral.messenger.message.message.IMessage;
import bet.astral.messenger.message.message.Message;
import bet.astral.messenger.message.part.IMessageComponent;
...
public abstract class AbstractMessenger<P, Comp, CommandSender> extends AbstractCommandMessenger<Comp, CommandSender> {
	...
	protected Map<String, IMessage<IMessageComponent<Comp>, Comp>> messages;
	...
	@Setter
	@NotNull
	private IComponentSerializer<Comp> messageTypeSerializer;
	@Getter
	@Setter
	private boolean consoleLogger = false;
	public final Class<Comp> componentType;

	public AbstractMessenger(CommandManager<CommandSender> commandManager, P main, Map<String, IMessage<IMessageComponent<Comp>, Comp>> messages, @NotNull IComponentSerializer<Comp> messageTypeSerializer, Class<Comp> componentType) {
	...
	@Nullable
	public abstract Component parse(@NotNull IMessage<?, Component> message, @NotNull ComponentType type, List<Placeholder> placeholders);
