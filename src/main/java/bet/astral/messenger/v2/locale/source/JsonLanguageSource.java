...
public class JsonLanguageSource extends AbstractFileLanguageSource implements FileLanguageSource{
	protected JsonLanguageSource(Locale locale, TranslationKeyRegistry registry, File file) throws IOException {
